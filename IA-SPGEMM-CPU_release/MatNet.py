...
def Pred(a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z):

    feature_input = [a,b,c,d,e,f,g,h,i,j,k,l,m,n,o,p,q,r,s,t,u,v,w,x,y,z]
    ...
    Test_feature = np.reshape(feature_input,[1,26])
    ...
    input3 = keras.layers.Input(shape=(26,))
    feature_dense1 = keras.layers.Dense(26, activation='tanh')(input3)
    ...
    output= keras.layers.Dense(5, activation='softmax')(added_layer)

    model = keras.models.Model(inputs=[input1,input2,input3], outputs=output)

    model.load_weights('./NetWeights/Intel_weights.h5')
    ...
    end_CPU = time.clock()
    print("Prediction cost: %f seconds" % (end_CPU - start_CPU))
